  ...
  return (
    <div className='w-2/3 pr-10'> 
        ...
        <div>
          {productData.map((item) => (
            ...
            className='flex items-center justify-between gap-6 mt-6'>
              ...
              <div className='w-52 flex items-center justify-between text-gray-500 gsp-4 border p-3'>
        ...
        <button onClick={() => dispatch(resetCart())& toast.error('Your Cart is Empty')}
          className='bg-red-500 tex-white mt-8 ml-7 py-1 px-6 hover:bg-red-800 duration-300'>
          Reset Cart
        </button>
        <Link to='/'>
